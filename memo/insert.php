...
if(!isset($_SESSION['userid'])){
    ...
    $sql="INSERT INTO memo(id, name, nicK, content, regist_day) VALUES(?,?,?,?,now())";
    $stmh= mysqli_prepare($connect, $sql);
    mysqli_stmt_bind_param($stmh,"ssss",$_SESSION['userid'], $_SESSION['username'], $_SESSION['usernick'], $content);
